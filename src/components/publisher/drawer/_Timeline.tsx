            ...
            {localData.length === 0 ? (
              ...
              <>
                {localData.map((item, index) => (
                  <div
                    key={index}
                    className="border rounded-lg border-gray-300 p-4 relative"
                  >
                    ...
                    <div className="mb-4">
                      <label className="flex items-center gap-2 cursor-pointer">
                        <input
                          ...
                          onChange={(e) =>
                            handleCurrentlyWorking(index, e.target.checked)
                          }

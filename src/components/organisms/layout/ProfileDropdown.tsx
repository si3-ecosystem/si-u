...
import { ChevronDown, ChevronRight, Grid, LogOut, Star, User } from "lucide-react"
...
export function ProfileDropdown({ username, subtext, avatarUrl, menuItems = [], onLogout }: ProfileDropdownProps) {
            ...
            <DropdownMenuContent align="end" className="w-64 p-0">
                ...
                <div className="!p-1">
                    {items.map((item, index) => (
                        <DropdownMenuItem key={index} asChild className="flex cursor-pointer justify-between !p-2 text-sm">

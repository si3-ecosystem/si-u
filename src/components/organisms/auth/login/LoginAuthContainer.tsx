...
const LoginAuthContainer: React.FC<LoginAuthContainerProps> = ({
  ...
  return (
    <section className="hide-scroll z-50 mx-auto flex max-w-xl flex-col justify-between space-y-6 bg-white px-4 sm:px-12 py-12 max-sm:rounded-l-[126px] sm:space-y-8 sm:rounded-t-[172px] sm:pt-46 sm:pb-16 md:min-w-[560px]">

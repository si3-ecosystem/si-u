...
import { GuideSessionCategory } from "@/types/siherguides/session";
...
interface GuidesPopularTopicsProps {
  data: {
    title?: string;
    description?: string;
    topicTitle?: string;
    topicDesc?: string;
    topics?: GuideSessionCategory[];  // Array of topics
  };
...
export function GuidesPopularTopics({
  data,
  categoryCounts = [],
  setSelectedCategory,
  selectedCategory,
}: GuidesPopularTopicsProps) {
